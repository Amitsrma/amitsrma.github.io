...
<ul>
      ...
      <ul>
        <li>Systems Science, Masters, Sept 2018 - Dec 2019, University of Ottawa</li>
...
<ul>
    ...
    While using Bloomberg terminal and checking news on seekingalpha, I would see new news being updated with time.
    ...
    Later I realized that some news are too long and it takes a long time to understand what the whole body of text is
    saying. Think about how fast you could understand the news, just by reading couple lines.
    <br>
    <ol>
    <li>
...
<li>
    ...
    <a target="_blank" href="/certificates/CertificateOfCompletion_Spark For Machine Learning Ai.pdf">
        <code>Certificate Link</code>
    </a>
</li>
<li>
